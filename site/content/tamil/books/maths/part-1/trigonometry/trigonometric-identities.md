...
![](/books/maths/part-1/trigonometry/trig20.png)
...
![trigonometry](/books/maths/part-1/trigonometry/trigonometric-identities/3.16.png )
...
{{< box title="எடுத்துக்காட்டு 3.15 " type="objective" >}}
...
**குறிப்பு:** (i) y = sin<sup>2</sup> x மற்றும் y = 2 sin x ஆகியவை வெவ்வேறானவை.
...
அளவிடும் சூத்திரம் \\( R = \dfrac{ u^2  sin 2a}{g} .\\)
 ...
 \\(\alpha\\)  = \\(\dfrac { \pi}{4} \\) எனும் போது R-ன் மீப்பெரும் மதிப்பு \\( \dfrac{u^2 sin \alpha }{g} \\) என்பது நமக்கு
தெளிவாகிறது.

\\( (iii) |sin A cos A | = | \dfrac{sin 2A}{2} | \le \dfrac{1}{2} \\)

\\( A = \dfrac{ \pi}{4} \\)எனும்போது sin A cos A-ன் மீப்பெரு மதிப்பு \\( \dfrac{1}{2}\\) ஆகும். எனவே,
...
**முற்றொருமை 3.8 :** cos<sup>2</sup> A = cos<sup>2</sup> A - sin<sup>2</sup> A
...
\\( = \dfrac { \dfrac{2 tan A}{1 - tan^2 A} + tan A} { 1 - \dfrac { 2 tan A }{1- tan^2 A}tan A } = \dfrac{3 tan A - tan^3 A}{1 - 3 tan^2 A}  \\)
...
இருமடங்குக் கோண முற்றொருமைகளில் \\( 2 A =  \theta 
...
\\( cos \theta = 1- 2sin^2 \dfrac{ \theta}{2} \implies sin \dfrac{ \theta}{2} = \pm \sqrt{ \dfrac{1 - cos \theta }{2} } \\)என நமக்குத் தெரியும். \\( \theta = 45° \\)என்க.
...
\\( sin x = 2 sin \dfrac{x}{2} cos \dfrac{x}{2} = 2 \times 2 \times sin \dfrac{x}{2^2 } cos \dfrac{x}{2^2 }  cos \dfrac{x}{2}\\)
...
9.\\( cot 7( \dfrac{1}{2}) = \sqrt 2 + \sqrt 3 +  \sqrt 4 + \sqrt 6 \\)   எனக் காண்பி.


10.\\(1 + sec 2\theta )(1 + sec 4\theta  ) ... (1 + sec 2^n \theta ) = tan 2^\theta cot \theta\\) என நிறுவுக.

11.\\(32 (\sqrt3) sin \dfrac {\pi} {48}  cos \dfrac {\pi} {48} cos \dfrac{\pi} {24} cos \dfrac{\pi} {12} cos \dfrac{\pi}{6} = 3\\)  என நிறுவுக.
...
முக்கோணவியல் சார்புகளின் சில பயன்பாட்டின்போது முக்கோணவியல் சார்புகளின் பெருக்கலை
முக்கோணவியல் சார்புகள் கூட்டல் அல்லது கழித்தலாக எழுத வேண்டிய தேவை ஏற்படுகிறது. சைன்
மற்றும் சொசைனின் கூட்டல் மற்றும் கழித்தல் முற்றொருமைகள் நடுவில் இருக்கும் குறியைத் தவிர
மற்றவைகள் ஒன்றுபோல் இருப்பது ஆச்சரியத்திற்குரியதாகும்.

இப்பண்பு அவற்றை இணைத்துப் புதிய முற்றொருமையை உருவாக்க ஏதுவாக உள்ளது.
அதன் மூலம் பெருக்கலைக் கூட்டலாகவும், கூட்டலைப் பெருக்கலாகவும் மாற்றி எழுதக்கூடிய பல
முற்றொருமைகள் கிடைக்கிறது.

(1)  sin( A + B ) = sinA cosB + cosAsinB    (3.1)

(2)  sin( A - B ) = sinA cosB - cosAsinB    (3.2)

(3)  cos( A + B ) = cosA cosB - sinAsinB    (3.3)

(4)  cos( A - B ) = cosA cosB + sinAsinB    (3.4)

**மேலேயுள்ள முற்றொருமைகளிலிருந்து நாம் எளிதாகப் பின்வரும் பெருக்கலிலிருந்து கூடுதல் முற்றொருமைகள் தருவிக்கலாம்.**

(5) \\( sinAcosB  =  \dfrac{1}{2} [sin (A+B) + sin(A-B)]\\)    (3.5)

(6) \\( cosAsinB  =  \dfrac{1}{2} [sin (A+B) - sin(A-B)]\\)   (3.6)

(7)  \\( cosAcosB =  \dfrac{1}{2} [cos (A+B) + cos(A-B)]\\)    (3.7)

(8) \\( sinAsinB  =  \dfrac{1}{2} [cos (A-B) - cos(A+B)]\\)    (3.8)

sine மற்றும் cosine-களின் பெருக்கலைக் கூடுதலாக மாற்றி அமைக்க வேண்டிய அவசியம்
தேவைபடும்போது மேற்கண்ட முற்றொருமைகள் அவசியமாகிறது. சிலதொகையிடலை மதிப்பிடுவதற்கு
இந்த யுக்தி பெரிதும் பயன்படுகிறது.


கூட்டலிலிருந்து பெருக்கல் முற்றொருமைக்கு, A B + = C மற்றும் A B - = D எனப் பிரதியிடலாம்
அல்லது மேலும் அதற்குச் சமமான \\( A = \dfrac{C+D}{2},  B = \dfrac{C-D}{2}\\) இவற்றை முற்றொருமைகள் (3.5)
இலிருந்து (3.8) வரை பிரதியிடவேண்டும். இதன் மூலம் பின் வருமாறு கூட்டலிருந்து பெருக்கலுக்கான
முற்றொருமைகள் நமக்கு கிடைக்கின்றன.


\\( sinC + sinD   =  2sin \dfrac{C+D}{2} cos\dfrac{C-D}{2}    \implies \\)         (3.9)


\\( sinC - sinD   =  2cos \dfrac{C+D}{2} sin\dfrac{C-D}{2}    \implies \\)         (3.10)


\\( cosC + cosD   =  2cos \dfrac{C+D}{2} cos\dfrac{C-D}{2}    \implies \\)         (3.11)
 ...
 **முற்றொருமை 3.16**:  \\(cos(60 \degree - A) cosAcos(60 \degree + A) = \dfrac{1}{4}cos3A\\)


**முற்றொருமை 3.17**:  \\(tan(60 \degree - A) tanAtan(60 \degree + A) = tan 3A\\)


**எடுத்துக்காட்டு 3.33**   **பின்வருவனவற்றைக் கூட்டல் அல்லது கழித்தலாகக் கூறு.**

(i)  sin40°  cos30°  (ii) cos110°   sin55°   (iii) sin\\(\dfrac{x}{2} cos\dfrac{3x}{2}\\)

தீர்வு:  

(i) 2sinAcosB = sin(A+B)+sin(A-B) என நமக்குத் தெரியும்.

A = 40° மற்றும் B = 30°  என்க.

 2 sin40° cos30°   = sin(40° + 30°) + sin(40° - 30°) = sin70° + sin10°

 எனவே, 

  sin40° cos30°   =    \\(\dfrac{1}{2}[sin70° + sin10°]\\)

  (ii)  2cosAsinB = sin(A+B) - sin(A-B) என நமக்குத் தெரியும்.

  A = 110° மற்றும் B = 55° என்க.

  2cos 110°  sin 55° = sin(110° + 55°) - sin(110° - 55°) எனக் கிடைக்கிறது.

எனவே, 

 cos110° sin55°   =     \\(\dfrac{1}{2}[sin165° - sin55°]\\)

 (iii) 2sinAcosB  =  sin(A+B) + sin(A-B) என நமக்குத் தெரியும்.

 A = \\(\dfrac{x}{2}\\)  மற்றும்  B = \\(\dfrac{3x}{2}\\) என்க

 \\( 2sin  \dfrac{x}{2}  cos \dfrac{3x}{2}  = sin (\dfrac{x}{2} + \dfrac{3x}{2}) + sin(\dfrac{x}{2} - \dfrac{3x}{2}\\))  எனக் கிடைக்கிறது.


  எனவே,  \\( sin \dfrac{x}{2} cos \dfrac{3x}{2}  =  \dfrac{1}{2}  [sin2x- sinx]\\)


**எடுத்துக்காட்டு 3.34**    **பின் வருவனவற்றை கூட்டல் மற்றும் கழித்தலைப் பெருக்கலாக கூறுக.**

(i) sin50°  + sin20°    (ii)cos6\\(\theta\\) + cos2\\(\theta\\)    (iii) \\(cos  \dfrac{3x}{2} - cos \dfrac{9x}{2}\\)

**தீர்வு:**

   \\(sinC+sinD =  2sin \dfrac{C+D}{2}cos \dfrac{C-D}{2} \\)என நமக்குத் தெரியும்.

(i)  C = 50°  மற்றும் D = 20°   என்க.

 \\(sin50°  +  sin20°   = 2sin \dfrac{50° + 20° }{2}cos \dfrac{50° - 20°}{2}  = 2sin35° cos15° \\) எனக் கிடைக்கிறது.

(ii) \\( cosC + cosD =   2cos \dfrac{C+D}{2} cos \dfrac {C-D}{2}\\) என நமக்குத் தெரியும்.

  \\( C = 6 \theta  மற்றும்  D = 2 \theta \\) என்க.


\\(cos 6 \theta + cos 2 \theta = 2cos \dfrac{ 6 \theta + 2 \theta}{2} cos \dfrac { 6 \theta - 2 \theta}{2}  =  2 cos 4\theta cos 2\theta \\) எனக் கிடைக்கிறது.


(iii) \\( cosC - cosD = 2 sin \dfrac{C+D}{2} sin \dfrac {D-C}{2} \\) என நமக்குத் தெரியும்.

\\( C = \dfrac{3x}{2} மற்றும் D = \dfrac{9x}{2}\\) என்க.


**எடுத்துக்காட்டு 3.35** sin34° +  cos64° - cos4° இன் மதிப்பைக் காண்க.

**தீர்வு:**

\\(sin34°+cos64° -cos4°  = sin34° - 2sin(\dfrac  {64° + 4°}{2}) sin(\dfrac  {64° - 4°}{2})\\)

= sin 34° - 2sin34° sin30° = 0


**எடுத்துக்காட்டு 3.36**   நிறுவுக. cos36°   cos72° cos108° cos144° = 1/16
...
**தீர்வு:**
   ...
   = sin<sup>2</sup>18° cos<sup>2</sup>36°

   = \\((\dfrac {\sqrt 5 - 1}{4})^2\\) \\((\dfrac {\sqrt 5 + 1}{4})^2\\) = \\(\dfrac{1}{16}\\)
...
\\( \dfrac {sin75° - sin15° }{cos75° + cos15°}\\)

**தீர்வு:**

\\( \dfrac {sin75° - sin15° }{cos75° + cos15°}\\)   = \\( 2cos (\dfrac{75°+15°}{2})sin (\dfrac{75°-15°}{2})\\) / \\( 2cos (\dfrac{75°+15°}{2})cos (\dfrac{75°-15°}{2})\\) 

= \\(\dfrac {2cos45° sin30° }{2cos45°cos30°}\\) = tan30°  = \\(\dfrac{1}{\sqrt3}\\)
