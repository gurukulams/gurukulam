...
(i) \\(x_{0}\\) மற்றும்  \\(x_{0}\\) என்ற புள்ளிகளில் f-ன் மதிப்புகளைக் காண்க. அதாவது, \\(f(x_{0})\\) மற்றும் \\(f(x_{0}+\Delta x)\\)

f(x0
+ Dx) ஆகியவற்றைக் காண்க.
(ii) Dy கணக்கிடுக: அதாவது Dy = f(x0

+ Dx) - f(x0

)-ஐ காண்க.

(iii) Dy-ஐ Dx ≠ 0ஆல் வகுக்க : அதாவது,
D
D
y
x
...
(iv) Dx ® 0 (Dx ≠ 0) எனும்போது :
D
D
y
x -ன் எல்லையைக் காண்க. அதாவது, mtan = limx
y
→ x