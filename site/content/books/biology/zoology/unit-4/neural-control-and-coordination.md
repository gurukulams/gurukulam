...
During this, \\(K^+\\) ion gates are more permeable
...
### 10.4 Central neural system (CNS) <br>
...
![](/books/zoology/unit-4/neural-control-and-coordination/9.png)<br>
...
**Table: 10.4** Differences between rod and cone cells <br>
